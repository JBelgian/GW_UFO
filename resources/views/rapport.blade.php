    ...
    <div class="flex justify-center">
        <div class="flex flex-col w-2/3">
            ...
            <form class="flex flex-col bg-green-middle p-2 rounded-lg text-green-dark">
                ...
                <input type="text" placeholder="locatie" class="p-1 m-1" maxlength="50" oninput="filterCityNameIntl(this)">
                <textarea placeholder="beschrijving" class="p-1 m-1 scrollbar-hide" rows="3"></textarea>
                <div class="flex flex-row p-2 justify-between">
                    <input type="file" id="imageInput" accept="image/png, image/jpeg, image/jpg" class="w-2/5">
